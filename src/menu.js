...
async function createMenu(gameData, app, coins, textStyle, textStyleCentered, texturesMenu) {
    ...
    menu.finaltitle.texts = ['by Alexander Thurn', 'github.com/alexanderthurn/beatthehodler', 'feuerware.com']
